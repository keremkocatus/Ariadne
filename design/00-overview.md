...
| 19 | polish-edit-plan.md | GUI turu 3: grid/menü cilası + connect-anı bug'ları + hücre düzenleme planı (P1-X1…X4) |
| 20 | grid-format-stats-plan.md | GUI turu 4: ayarlanabilir grid sütunları + SQL formatter + Activity butonu + DB istatistik şeridi (P1-Y1…Y3) |
